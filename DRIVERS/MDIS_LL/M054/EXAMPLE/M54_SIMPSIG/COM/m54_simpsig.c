 ...
 *
 * $Log: m54_simpsig.c,v $
 * Revision 1.4  2015/02/18 16:20:08  MRoth
 * R: not compatible to MDIS5 (no 64bit support)
 * M: ported to MDIS5 according porting guide rev. 0.10
 *
 * Revision 1.3  2004/04/19 15:56:43  cs
 * Minor modifications for MDIS4/2004 conformity
 *       changed prototype of function SigHandler to static
 *       commented function ShowIndications (prototype and definition) out
 * 		since not used currently
 *
 * Revision 1.2  2001/09/26 10:40:14  kp
 * cosmetics
 *
 * Revision 1.1  2001/09/25 16:27:43  kp
 * Initial Revision
 *
 *---------------------------------------------------------------------------
