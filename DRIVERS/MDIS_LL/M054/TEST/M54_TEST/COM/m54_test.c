 ...
 *
 * $Log: m54_test.c,v $
 * Revision 1.4  2015/02/18 16:20:15  MRoth
 * R: not compatible to MDIS5 (no 64bit support)
 * M: ported to MDIS5 according porting guide rev. 0.10
 *
 * Revision 1.3  2001/09/28 08:49:16  kp
 * cosmetics
 *
 * Revision 1.2  2001/09/26 10:40:16  kp
 * added test #4 to test polarity inversion
 *
 * Revision 1.1  2001/09/25 16:27:49  kp
 * Initial Revision
 *
 *---------------------------------------------------------------------------
